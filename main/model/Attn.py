...
class Attention(nn.Module):
    def __init__(
        ...
        qk_norm: Literal['l2', 'ln', 'none'] = 'l2', # 1112
    ...
    def forward(
        ...
        # Use separate linear projections for q and k/v origin
        if self.dim_context is not None:
            ...
            # Use single linear projection for q, k, and v
            qkv = self.to_qkv(kv_input)
