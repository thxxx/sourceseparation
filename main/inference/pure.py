...
@torch.no_grad()
def sample_dpmpp_3m_sde(model, x, sigmas, cross_attention_inputs, cross_attention_masks, seconds_start, seconds_total, cfg_scale=6, callback=None, melody_prompt=None, disable=None, eta=1., s_noise=1., noise_sampler=None, audio_embed=None):
    """DPM-Solver++(3M) SDE."""
